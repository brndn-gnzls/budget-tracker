...
// Get local storage items and populate them on page refresh.
...
form.addEventListener("submit", event => {
    ...
    addTransaction(form.source.value.trim(), Number(form.amount.value)) // Store id as integer.
    updateStatistics()
    form.reset()
})

function getTansaction() {
...
// Filter out all non-matching ids and remove matching id.
